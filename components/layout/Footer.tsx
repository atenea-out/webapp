...
import { ArrowUpRight, EnvelopeSimple, Phone, MapPin, LockKey } from '@phosphor-icons/react/dist/ssr'
  ...
  return (
    <footer className="bg-[var(--navy)] text-[var(--cream)]">
      ...
      <div className="border-t border-white/[0.07] border-b border-b-white/[0.05]">
        <div className="max-w-[1280px] mx-auto px-6 md:px-[60px] py-12 md:py-14 flex flex-col md:flex-row items-center md:items-center justify-between gap-8 text-center md:text-left">
          <div>
          ...
          <Link
            href={preHref}
            className="inline-flex w-full max-w-[260px] md:w-auto md:max-w-none items-center justify-center gap-2.5 px-8 py-4 bg-[var(--coral)] text-white text-[12px] font-medium tracking-[0.1em] uppercase border border-[var(--coral)] hover:bg-[var(--coral-light)] hover:border-[var(--coral-light)] transition-all duration-200 font-[family-name:var(--font-body)] flex-shrink-0"
          >
      ...
      {/* ── Main footer ── */}
      <div className="max-w-[1280px] mx-auto px-6 md:px-[60px] py-14 md:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="mx-auto md:mx-0 text-[13px] text-white/50 leading-[1.8] mb-7 max-w-[220px]">
            {description}
          </p>
          <div className="flex justify-center md:justify-start gap-2.5">
            {socialLinks.map(({ Icon, label, url }) => (
              <a
                ...
                className="flex h-[42px] w-[42px] items-center justify-center border border-white/20 bg-white/[0.04] text-white/72 transition-all duration-200 hover:border-[var(--coral)]/70 hover:bg-[var(--coral)]/12 hover:text-white"
                aria-label={label}
              >
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex justify-center md:justify-start gap-3 items-center">
