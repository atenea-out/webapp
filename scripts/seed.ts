...
async function main() {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      servicesCtaTitle: 'No estas seguro que servicio necesitas?',
      servicesCtaDescription: 'Contactanos y te orientamos sin compromiso.',
      servicesCtaLabel: 'Hablar con un experto',
      servicesCtaHref: '/contacto',
      serviceDetailBackLabel: 'Todos los servicios',
      serviceDetailIncludesTitle: 'Que incluye este servicio?',
      ...
      serviceDetailCtaLabel: 'Solicitar informacion',
      serviceDetailPhoneLabel: 'Llamanos',
      serviceDetailMoreLabel: 'Tambien ofrecemos',
      ...
      industriesCtaTitle: 'Tu industria no esta en la lista?',
      ...
      newsPageTitle: 'Noticias y Articulos',
      newsPageDescription:
      ...
      newsEmptyText: 'Aun no hay noticias publicadas. Vuelve pronto.',
      newsReadLabel: 'Leer articulo',
      newsReadMoreLabel: 'Leer mas',
      newsDetailBackLabel: 'Todas las noticias',
      newsDetailCtaTitle: 'Necesitas asesoria?',
      ...
      newsDetailMoreLabel: 'Ver mas articulos',
      ...
      privacyIntro:
        'En Atenea Outsourcing, nos comprometemos a proteger la privacidad de los datos personales que nos confian.',
      privacySections: [
        {
          title: 'Datos que recopilamos',
          text: 'Al utilizar nuestro formulario de contacto, recopilamos nombre completo, correo electronico, telefono opcional y contenido del mensaje.',
        },
        {
        ...
        },
        {
          ...
          text: 'El titular puede solicitar acceso, rectificacion, cancelacion u oposicion escribiendo al correo principal del sitio.',
        },
        {
          title: 'Seguridad',
          text: 'Aplicamos medidas tecnicas y organizativas adecuadas para proteger los datos contra accesos no autorizados.',
        },
      ],
      privacyUpdatedAtLabel: 'Ultima actualizacion: abril 2025',
      ...
      valores: [
        {
          ...
          imageUrl:
            'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=2000&q=90&auto=format&fit=crop',
        },
        {
          ...
          imageUrl:
            'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=2000&q=90&auto=format&fit=crop',
        },
        {
          title: 'Compromiso',
          description: 'Relaciones de largo plazo basadas en resultados reales y confianza mutua.',
          imageUrl:
            'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=2000&q=90&auto=format&fit=crop',
        },
        {
          title: 'Innovación',
          description:
          ...
          imageUrl:
            'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=2000&q=90&auto=format&fit=crop',
        },
      ],
